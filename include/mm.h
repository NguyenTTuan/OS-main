...
#define PAGING_PAGE_SWP(pte) (pte&PAGING_PTE_SWAPPED_MASK)
...
// #define TLB_CACHE_SIZE 64*1024     // size of TLB cache: 64KB
// #define TLB_CACHE_LINE_SIZE 4       // 4 byte
// #define TLB_ENTRIES (TLB_CACHE_SIZE/TLB_CACHE_LINE_SIZE) 
